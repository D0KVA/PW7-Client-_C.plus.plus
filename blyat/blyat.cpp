...
int main()
{
    ...
    const char* sendBuffer1 = "Привет от первого клиента";  // Сообщение для отправки.
    const char* sendBuffer2 = "Фишман, встань мид! Ты играешь 20 ммов в день, обьясни мне, нафига!";  // Второе сообщение для отправки.
